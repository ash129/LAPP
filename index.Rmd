...
# Human Leukocyte Antigens and their Peptides
...
```{r cartoon_cells, echo= FALSE, fig.align='center', fig.cap="The role of HLA in healthy and infected cells."}
knitr::include_graphics("C:/Users/Alex/Desktop/LAPP.short/figs/cartoon.cells.png")
```

![](C:/Users/Alex/Desktop/LAPP.short/figs/cartoon.cells.png)

![](images/figs/cartoon.cells.png)
...
As an example consider two people, Andrew and Beatrice, who have slightly different HLA. Andrew's HLA recognize 3 different peptides. Beatrice has a slightly different looking HLA that can only pick up two different peptides. Andrew's and Beatrice's leukocytes therefore have been trained to recognize those three and two peptides respectively. 

```{r cartoon_organs1, echo= FALSE, fig.align='center', fig.cap="Andrew and Beatrice have two different HLA, upon which their leukocytes have been trained to not attack. "}
knitr::include_graphics("C:/Users/Alex/Desktop/LAPP.short/figs/cartoon.organs.1.png")
```
...
```{r cartoon_oragns2, echo= FALSE, fig.align='center', fig.cap="Andrew and Beatrice may suffer from their difference in HLA when donating organs to one another. "}
knitr::include_graphics("C:/Users/Alex/Desktop/LAPP.short/figs/cartoon.organs.2.png")
```
